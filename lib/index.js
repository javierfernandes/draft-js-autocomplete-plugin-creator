...
var createCompletionPlugin = function createCompletionPlugin(completionSuggestionsStrategy, addModifier, SuggestionEntry) {
  ...
  var decoratorComponent = arguments[5];
  return function () {
    var _store;
    ...
    }, _defineProperty(_store, 'register', function register(offsetKey) {
      searches = searches.set(offsetKey, offsetKey);
    }), _defineProperty(_store, 'isSearchActive', function isSearchActive(offsetKey) {
      return searches.has(offsetKey);
    }), _defineProperty(_store, 'unregister', function unregister(offsetKey) {
      searches = searches.delete(offsetKey);
      clientRectFunctions = clientRectFunctions.delete(offsetKey);
    }), _store);
    ...
    return _extends({
      ...
      decorators: [{
        ...
        component: (0, _decorateComponentWithProps2.default)(_CompletionSuggestionsPortal2.default, { autocompleteStore: store, decoratorComponent: decoratorComponent })
